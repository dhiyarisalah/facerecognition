...
model_path = './models/3_custom1_ori.h5'
...
def process_face(face_img):
    ...
    return class_index, labels[class_index] if confidence > 30 else "Unknown", confidence
...
# cap = cv2.VideoCapture(0)  # Adjusted to default camera, change it if using another camera
